#
# Be sure to run `pod lib lint TKDataStorageCategory.podspec' to ensure this is a
...
数据存储模块对外接口，暂时未想到更好的方法.
  ...
  s.source_files = 'TKDataStorageCategory/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TKDataStorageCategory' => ['TKDataStorageCategory/Assets/*.png']
  # }
